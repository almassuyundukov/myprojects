...
public class Main {
    public static void main(String[] args) {
        ...
        // проверим содержит ли пароль цифры (способ номер 1)
        ...
        for (int i = 0; i < numbers.length; i++) {
            String currenNum = numbers[i];
            if (password.contains(currenNum)) {
                countNumInPassword++;
            }
        }

        if (countNumInPassword < 2) {
            System.out.println("Цифр меньше 2");
            return;
        }
    }
}
